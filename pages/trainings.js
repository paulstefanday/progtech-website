...
const Description = () => (
  <Flex flexDirection="column" width={[1, 1 / 2]} pr={[0, 5]}>
    ...
    <Heading variant="highlight.pink">Data automations with Zapier & custom webhooks - run by Code Nation</Heading>
    <p><strong>Session 1: Getting started with Zapier, Thursday 22 October 11am - 12.30pm AEDT</strong></p>
    <p><strong>Session 2: Zapier automations using webhooks and custom API requests, Thursday 29 October 11am - 12.30pm AEDT</strong></p>
