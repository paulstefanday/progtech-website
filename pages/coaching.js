...
const Description = () => (
  <Flex flexDirection="column" width={[1, 1 / 2]} pr={[0, 5]}>
    ...
    <p><ul>
      ...
      <li><b>Georgia Kriz</b>, Digital and Social Media Manager, Australian Council of Trade Unions. Georgia previously worked in communications for the Australian Manufacturing Workers' Union and as an organiser on the Australian Marriage Equality campaign. Can help with: digital campaigning, digital communications and digital organising.</li>
